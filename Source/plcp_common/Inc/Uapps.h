...
U16 Aps_UartMessage(UappsMessage *pMsg, U8 *sendBuff, U16 sendBuffMaxSize);
/*-----------------------Uapps 寮€濮?---------------------------------------*/
/**
...
---------------------------------------------------------------*/
u8 hexTostr(u8 *buf, u8 len, char *prefix, char *str);
...
备 注：
---------------------------------------------------------------*/
U16 APP_StrToHex(U8 *inputStr, U16 inputStrLen, U8 *resultHexArray);
...
U8 isUappsData(char *inputStr, u16 inputStrLen, u16 *uappsDataStartIndex);

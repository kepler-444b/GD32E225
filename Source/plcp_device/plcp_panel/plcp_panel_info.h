...
#define RELAY_GPIO_MAP_DEF {PB14, PB13, PB12, PB15}             // 继电器 GPIO 映射
#define LED_W_GPIO_MAP_DEF {PWM_PB0, PWM_PB1, PWM_PB7, PWM_PB6} // LED 白灯 GPIO
#define LED_Y_GPIO_MAP_DEF {PA15, PB3, PB5, PB4}                // LED 黄灯 GPIO
